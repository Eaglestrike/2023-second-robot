...
namespace EIAutoConstants{
    const double HALFSTOW_PERCENT = 0.2; // 0 to 0.25 are halfstowing
    const double ELEVATOR_PERCENT = 0.2; // 2.5 to 0.75 are moving elevator
    const double INTAKE_PERCENT = 0.2; // 0.75 to 1 are moving wrist
    const double ROLLER_PERCENT = 0.1;
