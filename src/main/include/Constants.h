...
//controller for extending and stowing
const double EXTND_STOW_MAX_VOLTAGE = 0;

const double EXTND_STOW_P = 0;
const double EXTND_STOW_I = 0;
const double EXTND_STOW_D = 0;

const double EXTND_STOW_POS_ERR_TOLERANCE = 0;  
const double EXTND_STOW_VEL_ERR_TOLERANCE = 0;

// controller for buddy climb
const double CLIMB_MAX_VOLTAGE = 0;

const double CLIMB_P = 0;
const double CLIMB_I = 0;
const double CLIMB_D = 0;

const double CLIMB_POS_ERR_TOLERANCE = 0;  
const double CLIMB_VEL_ERR_TOLERANCE = 0;

//target positions
const double STOWED_POS = 0; 
const double EXTENDED_POS = 0;
const double LIFTED_POS = 0; 
